            ...
            <div className="lg:col-span-7 flex flex-col justify-between gap-6 lg:gap-8">
              ...
              >
                <p className="body-text text-white/90 leading-relaxed text-base md:text-lg">
                  Based in Jakarta, <span className="text-white font-medium">Seno</span> is a multidisciplinary filmmaker focusing on emotionally-driven narratives, intimate visuals, and atmospheric storytelling.
                </p>
              ...
              >
                ...
                <div className="overflow-x-auto overflow-y-hidden pb-3 -mx-4 px-4 md:mx-0 md:px-0" style={{
                  scrollbarWidth: 'thin',

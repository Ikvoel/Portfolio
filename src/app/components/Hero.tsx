...
export function Hero() {
	...
	return (
		<section className="relative h-screen flex items-center justify-center overflow-hidden">
			...
			<motion.div initial={{ opacity: 0, y: -20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8, delay: 0.3 }} className="absolute top-4 left-4 md:top-8 md:left-8 z-20">
				<img src="https://i.ibb.co.com/MD6xpWds/hsno-mark-f.png" alt="Logo" className="w-auto h-16 md:h-24 lg:h-32 drop-shadow-2xl" />
			</motion.div>
			...
			<div className="relative z-10 text-center px-6 max-w-5xl mx-auto">
				<motion.div initial={{ opacity: 0, y: 40 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 1, delay: 0.2 }}>
					...
					<motion.h1 className="section-title mb-6 text-white" initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8, delay: 0.4 }}>
						Husein
					</motion.h1>
					...
					>
						Crafting cinematic experiences through visual storytelling
					</motion.p>
					...
					>
						...
						<motion.div className="absolute inset-0 bg-gradient-to-r from-purple-500/20 to-pink-500/20" initial={{ opacity: 0 }} whileHover={{ opacity: 1 }} transition={{ duration: 0.3 }} />
					</motion.button>
				</motion.div>
			</div>

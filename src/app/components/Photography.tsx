...
const photoGallery = [
	...
	{
		id: 20,
		title: "Kadapi Fadli at Cotta Haus",
		category: "Event",
		year: "2023",
		image: "https://i.ibb.co.com/rKc2SJBF/S3-N0-LOG-33.jpg",
		description: "",
	},
	{
		id: 21,
		title: "Geisha at Cotta Haus",
		category: "Event",
		year: "2023",
		image: "https://i.ibb.co.com/ZR6fDRG0/S3-N0-LOG-69.jpg",
		description: "Minimalist product shots with dramatic lighting.",
	},
	{
		id: 22,
		...
		category: "Event",
		year: "2023",
		image: "https://i.ibb.co.com/bRqchrDx/S3-N0-LOG-287.jpg",
		description: " ",
	},
	{
		id: 23,
								...
								<Masonry gutter="1rem">
									{photos
										...
										.map((photo, index) => (
											...
											>
												{/* CARD */}
												<motion.div whileHover={{ scale: 1.015 }} transition={{ type: "spring", stiffness: 260, damping: 22 }} className="relative overflow-hidden rounded-xl liquid-glass-card">

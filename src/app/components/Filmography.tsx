...
const projects = [
  {
    ...
    clientLogos: [
      { name: 'Aftertone Pictures', logo: 'https://i.ibb.co.com/B5dk6Z9Q/logo-aftertone-white-color.png', hasGlassBadge: false }
    ]
  },
  {
    id: 3,
  ...
  },
  {
    ...
    clientLogos: [
      { name: 'Wawayu Pictures', logo: 'https://i.ibb.co.com/qYfk4ZbZ/logo.png', hasGlassBadge: false }
    ]
  },
  {
    id: 5,
